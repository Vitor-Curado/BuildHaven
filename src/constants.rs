...
pub mod icons {
    ...
    pub const LANGUAGE: &str = "language.svg";
    pub const LOGIN: &str = "login.svg";
    pub const RESUME: &str = "resume.svg";
    pub const SOFTWARE: &str = "software.svg";
    pub const THEME: &str = "theme.svg";
}
